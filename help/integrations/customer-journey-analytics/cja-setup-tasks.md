...
完成这些步骤并将数据视图提供给Adobe客户团队后，您可以完成其他步骤来设置集成。
...
### 步骤2：在Analysis Workspace中创建一个包含要导出的指标的数据视图
...
### 步骤1：在Customer Journey Analytics中设置连接

>[!VIDEO](https://video.tv.adobe.com/v/3476860)

### 步骤2：在Customer Journey Analytics中设置数据视图
